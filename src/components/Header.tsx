...
import { GraduationCap, Menu, X, Users, Calendar, MessageSquare, BookOpen, User, Settings, LogOut, Shield } from "lucide-react";
...
const Header = () => {
  ...
  const authenticatedNavItems = [
    ...
    ...(user?.role === 'staff' ? [{ name: "Manage Events", href: "/events", icon: Calendar }] : []),
  ];
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <Link to="/" className="flex items-center space-x-3 hover:opacity-90 transition-opacity">
            <div className="bg-gradient-hero p-2 rounded-xl shadow-lg hover:shadow-xl transition-all duration-200 hover:scale-105">
            ...
            <div>
              ...
              <p className="text-xs text-muted-foreground hidden sm:block">Student Activity Portal</p>
            </div>
          </Link>
          ...
          <div className="hidden md:flex items-center space-x-3">
            {isAuthenticated ? (
              ...
              <>
                ...
                <Button variant="hero" size="sm" asChild className="shadow-lg hover:shadow-xl">
