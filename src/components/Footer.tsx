        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h3 className="text-xl font-bold">BRACU Portal</h3>
                <p className="text-sm text-primary-foreground/80">Student Activity Portal</p>
              </div>
            </div>
            ...
            <div className="flex space-x-3">
              <a href="#" className="bg-white/10 hover:bg-white/20 p-2 rounded-lg transition-all duration-200 hover:scale-110">
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center space-x-3">
                ...
                <span className="text-primary-foreground/80 text-sm">+880 2 9844051-4</span>
              </div>
              <div className="flex items-center space-x-3">
                <div className="bg-white/10 p-1.5 rounded-md">
                  <MapPin className="h-4 w-4" />
                </div>
                <span className="text-primary-foreground/80 text-sm">66 Mohakhali, Dhaka 1212, Bangladesh</span>
              </div>
            </div>
          </div>
        </div>
